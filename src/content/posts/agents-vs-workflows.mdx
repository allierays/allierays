...
<a href="https://www.youtube.com/watch?v=ykQJCey5s7g" target="_blank" rel="noopener" style="display: block; position: relative; margin: 0 0 2rem 0;">
<img src="/images/agents-vs-workflows-banner.png" alt="Agentic Workflows, Agents, and Multi-Agent Systems" style="width: 100%; border-radius: 8px; border: none; box-shadow: none; float: none; max-width: 100%; margin: 0;" />
